...
namespace MediaScoutGUI.GUITypes
{
    public class Episode : INotifyPropertyChanged
    {
        ...
        private String se;  // Season-Episode (Episode Guide List)
        private String prodnum; // Production Number (Episode Guide List)
        private String airdate; // AitDate (Episode Guide List)
