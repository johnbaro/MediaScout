    ...
    public class TheTVDBProvider : ITVMetadataProvider
    {
        ...
        public TVShow GetTVShow(String TVShowID, String Language, String CacheDirectory, DateTime dtCacheTime)
        {
            ...
            try
            {
                ...
                {
                    //for example - http://www.thetvdb.com/api/4AD667B666AA62FA/series/75930/all/en.xml
                    xdoc.Load(urlMetadata + TVShowID + "/all/" + Language + ".xml");
                    Debug.WriteLine("Fetching " + urlMetadata + TVShowID + "/all/" + Language + ".xml");
                }
                ...
                Message("Series name \"" + SeriesName + "\"", MediaScoutMessage.MessageType.ProcessSeries, DateTime.Now);
                ...
                foreach (XmlNode x in nodeList)
                {
                    ...
                    String AirDate = x["FirstAired"].InnerText;
                    String ProdNum = x["ProductionCode"].InnerText;
        ...
        {
            XmlDocument xdoc = new XmlDocument();
            Debug.WriteLine("Fetching " + urlMetadata + TVShowID + "/banners.xml");
