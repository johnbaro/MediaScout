...
namespace MediaScoutGUI
{
	...
	public class TitleSelectionDialog : Window, IComponentConnector
	{
		...
		public void InitializeComponent()
		{
			...
			Uri resourceLocator = new Uri("/MediaScoutGUI;component/titleselectiondialog.xaml", UriKind.Relative);
