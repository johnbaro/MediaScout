...
namespace MediaScoutGUI
{
	...
	public class ChangeTVBanner : Window, IComponentConnector, IStyleConnector
	{
		...
		public void InitializeComponent()
		{
			...
			Uri resourceLocator = new Uri("/MediaScoutGUI;component/changetvbanner.xaml", UriKind.Relative);
