...
namespace MediaScoutGUI
{
	...
	public class ProcessAllMoviesDialog : Window, IComponentConnector, IStyleConnector
	{
		...
		{
			this.LoadingThread = new Thread(delegate
			{
		...
		public void InitializeComponent()
		{
			...
			Uri resourceLocator = new Uri("/MediaScoutGUI;component/processallmoviesdialog.xaml", UriKind.Relative);
