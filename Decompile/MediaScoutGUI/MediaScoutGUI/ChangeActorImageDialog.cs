...
namespace MediaScoutGUI
{
	...
	public class ChangeActorImageDialog : Window, IComponentConnector, IStyleConnector
	{
		...
		public void InitializeComponent()
		{
			...
			Uri resourceLocator = new Uri("/MediaScoutGUI;component/changeactorimagedialog.xaml", UriKind.Relative);
		...
		void IComponentConnector.Connect(int connectionId, object target)
		{
			...
			{
			case 1:
				((ChangeActorImageDialog)target).Loaded += new RoutedEventHandler(this.Window_Loaded);
				((ChangeActorImageDialog)target).Closed += new EventHandler(this.Window_Closed);
				return;
			case 2:
