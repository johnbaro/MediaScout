...
namespace MediaScoutGUI.Controls
{
	...
	public class ImageControl : UserControl, IComponentConnector
	{
		...
		public void InitializeComponent()
		{
			...
			Uri resourceLocator = new Uri("/MediaScoutGUI;component/controls/imagecontrol.xaml", UriKind.Relative);
